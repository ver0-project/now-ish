...
const millisecond: Unit = {
    ...
    'round-up': (time) =>
        time
            .round({smallestUnit: 'millisecond', roundingMode: 'floor'})
            .add({milliseconds: 1})
            .subtract({nanoseconds: 1}),
    'round-down': (time) =>
        time.round({smallestUnit: 'millisecond', roundingMode: 'floor'}),
};
...
const second: Unit = {
    ...
    'round-up': (time) =>
        time
            ...
            .subtract({nanoseconds: 1}),
    'round-down': (time) =>
        time.round({smallestUnit: 'second', roundingMode: 'floor'}),
};
...
const minute: Unit = {
    ...
    'round-up': (time) =>
        time
            ...
            .subtract({nanoseconds: 1}),
    'round-down': (time) =>
        time.round({smallestUnit: 'minute', roundingMode: 'floor'}),
};
...
const hour: Unit = {
    ...
    'round-up': (time) =>
        time
            ...
            .subtract({nanoseconds: 1}),
    'round-down': (time) =>
        time.round({smallestUnit: 'hour', roundingMode: 'floor'}),
};
